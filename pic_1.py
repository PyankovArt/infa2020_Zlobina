...
def draw_deck(boat_0_x, boat_0_y, proportion):
	...
	polygon(screen, (139, 80, 20), [(boat_0_x + proportion * 28 + 2, boat_0_y),
	 (boat_0_x + proportion * 28 + 2, boat_0_y + proportion * 7 - 1), (boat_0_x + proportion * 43, boat_0_y)])
...
def draw_sail(sail_x, sail_y, proportion):
	rect(screen, (0, 0, 0), (sail_x, sail_y, proportion * 2 - 2,  2 * 10 * proportion))
	polygon(screen, (218, 173, 128), [(sail_x + proportion * 2 - 2, sail_y),
	 (sail_x + proportion * 6, sail_y + proportion * 10), (sail_x + proportion * 14, sail_y + proportion * 10)])
	polygon(screen, (218, 173, 128), [(sail_x + proportion * 2 - 2, sail_y + proportion * 10 * 2),
	 (sail_x + proportion * 6, sail_y + proportion * 10), (sail_x + proportion * 14, sail_y + proportion * 10)])
...
for i in range(60):
	polygon(screen, (255, 255, 0), [(540 + R * np.sin ( 2 * i * np.pi / Sunlights), 
	60 - R * np.cos (2 * i * np.pi / Sunlights)), (540 + R * np.sin ( (2 * i + 1) * np.pi / Sunlights),
	 60 - R * np.cos ((2 * i + 1) * np.pi / Sunlights)), ((540 + (R + r) * np.sin ((2 * i + 0.5) * np.pi / Sunlights),
	  60 - (R + r) * np.cos ((2 * i + 0.5) * np.pi / Sunlights)))])
